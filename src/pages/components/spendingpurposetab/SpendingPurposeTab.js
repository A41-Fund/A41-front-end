    ...
    <div className="voting-card">
      <div className="card-information">
        <div className='header'>
          ...
          <i className='icon' class="fa-solid fa-ellipsis-vertical" style={{color: 'white', alignSelf:'flex-end'}}></i>
          </div>
          <h4>{purpose}</h4>
        </div>
        <p className="cost">
        ...
        <p>
          <strong>Yes:</strong> {yesPercentage.toFixed(2)}%
        </p>
        <p>
          <strong>No:</strong> {noPercentage.toFixed(2)}%
        </p>
      </div>
